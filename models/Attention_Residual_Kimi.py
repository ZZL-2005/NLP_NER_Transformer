...
from models.AttnResTransformerEncoder import AttnResTransformerEncoder,AttnResTransformerEncoder_MY
...
class AttnResTransformerNER_MY(nn.Module):
    def __init__(
        self,
        vocab_size: int,
        num_tags: int,
        ...
        self.encoder = AttnResTransformerEncoder_MY(
            num_layers=num_layers,
            d_model=d_model,
            n_heads=n_heads,
            d_ff=d_ff,
